...
export default function Profile({ profile }: any) {
    const { nftVerified, name, description, pfp, location, occupation, organization, whatCan, wantMeet } = profile || {}
    const router = useRouter()
    // const { address } = useAccount()
    const address = '0x38..3434'
        ...
        <Flex margin='auto' width={{ base: '100%', md: '60%', lg: '50%' }} justifyContent='center' alignItems='center'>
            <Layout>
                ...
                <Flex style={styles.switch}>
                    ...
                    <Toggle checked={isPreferedContact} name='burritoIsReady' value='yes' onChange={toggleSwitch} />
                </Flex>
