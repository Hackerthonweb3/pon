...
export function ChatBox({ orbis, context }) {
    if (orbis) {
        return <ChatBoxContent orbis={orbis} context={context} />
    } else {
        return <ChatBoxContent orbis={_orbis} context={context} />
    }
}
...
function Messages({ user, messages, reply, replyTo }) {
    ...
    return messages.map((message, key) => {
        return <Message user={user} message={message} key={key} reply={reply} replyTo={replyTo} />
    })
}
            ...
            <div className={styles.flexColumn}>
                {message.reply_to && (
                    <div className={styles.flexRow}>
                        ...
                        <div className={styles.chatBoxOneMessageReply}>
                ...
                <div className={styles.chatBoxOneSupportMessage}>
        ...
        <div className={styles.chatBoxMessageBoxContainer}>
            ...
            {replyTo && (
                <div className={styles.chatBoxContactReplyToInfo}>
                    <p>
                        <span className={styles.chatBoxContactReplyToInfoLabel}>Replying to:</span>{' '}
                        {replyToText && replyToText.length > 30 ? shortMessage(replyToText, 30) : replyToText}
                    </p>
                </div>
            )}
    ...
    return (
        <>
            {user ? (
                ...
                <div className={styles.btnBlack} onClick={() => connect()}>
                    Connect
                </div>
            )}
        </>
